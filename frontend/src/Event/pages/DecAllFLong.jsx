//event organiser dashboard londay declined fooddrives
...
export default function DecAllFdLong() {
    ...
    useEffect(() => {
      const fetchFooddrives = async () => {
        try {
         ...
         const res = await fetch(`/api/fooddrive/getfooddrives?type=longdrive&status=declined`);
