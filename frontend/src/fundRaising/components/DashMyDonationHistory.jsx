...
export default function DashMyDonationHistory() {
    ...
    const fetchDonations = async () => {
      try {
        ...
        const res = await fetch(
          `/api/frpdonation/getfrpdonations?userId=${currentUser._id}`
        );
  ...
  const handleShowMore = async () => {
    ...
    try {
      const res = await fetch(
        `/api/frpdonation/getfrpdonations?userId=${currentUser._id}&startIndex=${startIndex}`
      );
      const data = await res.json();
      if (res.ok) {
