...
export default function FrpDonations({ frp_Id, user_Id }) {
  ...
  const [donerCount, setDonerCount] = useState("");
      ...
      try {
        // const res = await fetch(`/api/post/getposts?userId=${currentUser._id}`);
            ...
            const res = await fetch(
              `/api/frpdonation/getfrpdonations?frpId=${frp_Id}`
            );
        ...
        if (res.ok) {
          ...
          setDonerCount(data.uniqueUsersCount);
  ...
  const handleShowMore = async () => {
    ...
    try {
      const res = await fetch(
        `/api/frpdonation/getfrpdonations?frpId=${frp_Id}&startIndex=${startIndex}`
      );
      const data = await res.json();
      if (res.ok) {
          ...
          <>
            <Table hoverable className="shadow-md">
              <Table.Head>
                ...
                <Table.HeadCell>Doner</Table.HeadCell>
