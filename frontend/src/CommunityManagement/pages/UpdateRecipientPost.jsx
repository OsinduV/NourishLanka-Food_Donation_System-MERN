...
export default function UpdateRecipientPost() {
    const { postId } = useParams(); // Use useParams to get postId from URL parameters
    ...
    return (
      <div className='p-3 max-w-3xl mx-auto min-h-screen'>
        <h1 className='text-center text-3xl my-7 font-semibold'>Update Recipient post</h1>
