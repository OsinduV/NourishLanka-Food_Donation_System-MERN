...
export const getvolunteer = async (req, res, next) => {
  try {
    ...
    const foodbankId = req.query.foodbankId;
    const foodbankIdObject = foodbankId ? new mongoose.Types.ObjectId(foodbankId) : null;
    ...
    const volunteers = await Volunteer.find({
      ...
      ...(foodbankIdObject && { foodbankId: foodbankIdObject }),
